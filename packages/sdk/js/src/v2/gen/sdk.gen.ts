...
import type {
  ...
  SessionRouteCardsErrors,
  SessionRouteCardsResponses,
  SessionRouteErrors,
...
export class App extends HeyApiClient {
   ...
   * List agents
   *
   * Get a list of all available AI agents in the Maji system.
   */
   ...
   * List skills
   *
   * Get a list of all available skills in the Maji system.
   */
...
export class Capabilities extends HeyApiClient {
   ...
   *
   * Get experimental features enabled on the Maji server.
   */
...
export class Console extends HeyApiClient {
   ...
   *
   * Persist a new active Console account/org selection for the current local Maji state.
   */
...
export class Config extends HeyApiClient {
   ...
   *
   * Retrieve the current global Maji configuration settings and preferences.
   */
   ...
   *
   * Update global Maji configuration settings and preferences.
   */
...
export class Global extends HeyApiClient {
   ...
   * Get health
   *
   * Get health information about the Maji server.
   */
   ...
   * Get global events
   *
   * Subscribe to global events from the Maji system using server-sent events.
   */
   ...
   * Dispose instance
   *
   * Clean up and dispose all Maji instances, releasing all resources.
   */
...
export class Config2 extends HeyApiClient {
   ...
   * Get configuration
   *
   * Retrieve the current Maji configuration settings and preferences.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   *
   * Update Maji configuration settings and preferences.
   */
  public update<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Instance extends HeyApiClient {
   ...
   * Dispose instance
   *
   * Clean up and dispose the current Maji instance, releasing all resources.
   */
...
export class Command extends HeyApiClient {
   ...
   * List commands
   *
   * Get a list of all available commands in the Maji system.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Project extends HeyApiClient {
   ...
   * List all projects
   *
   * Get a list of projects that have been opened with Maji.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get current project
   *
   * Retrieve the currently active project that Maji is working with.
   */
...
export class Pty extends HeyApiClient {
   ...
   * List PTY sessions
   *
   * Get a list of all active pseudo-terminal (PTY) sessions managed by Maji.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Session2 extends HeyApiClient {
   ...
   * List sessions
   *
   * Get a list of all Maji sessions, sorted by most recently updated.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Create session
   *
   * Create a new Maji session for interacting with AI assistants and managing conversations.
   */
  public create<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
      ...
      [
        {
          args: [
            ...
            { in: "query", key: "workspace" },
            { in: "body", key: "text" },
            { in: "body", key: "currentSessionID" },
          ],
        },
      ],
    )
    return (options?.client ?? this.client).post<SessionRouteResponses, SessionRouteErrors, ThrowOnError>({
      url: "/session/route",
      ...options,
      ...params,
      headers: {
   ...
   */
  public routeCards<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
      workspace?: string
    },
    ...
    return (options?.client ?? this.client).get<SessionRouteCardsResponses, SessionRouteCardsErrors, ThrowOnError>({
   ...
   * Get session
   *
   * Retrieve detailed information about a specific Maji session.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
