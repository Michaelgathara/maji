export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Maji",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Maji. ¿Quieres instalarla y reiniciar?",
