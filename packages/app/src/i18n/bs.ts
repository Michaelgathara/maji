export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Maji",
  "dialog.model.unpaid.addMore.title": "Dodaj još modela od popularnih provajdera",
  "dialog.model.unpaid.viewMoreProviders": "Prikaži još 70+ provajdera",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Maji-u.",
  ...
  "provider.connect.opencodeZen.line1":
    "Maji Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Maji-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Maji-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u maji.json",
  ...
  "dialog.server.description": "Promijeni na koji se Maji server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera Maji...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera Maji u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje Maji...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje Maji u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj Maji u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj Maji",
  "wsl.onboarding.opencodeReadyIn": "Maji je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.opencodeReady": "Maji je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj Maji u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj Maji",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Maji nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi Maji mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "Maji nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori Maji.",
  ...
  "toast.update.description": "Nova verzija Maji-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Maji timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (maji.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Maji još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Maji uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Maji server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Maji-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako Maji izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Maji prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Maji-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Maji pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Maji-a.",
