export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Maji",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Maji.",
  ...
  "provider.connect.opencodeZen.line1":
    "Maji Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Maji.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Maji.",
  ...
  "dialog.plugins.empty": "Plugins configurados em maji.json",
  ...
  "dialog.server.description": "Trocar para qual servidor Maji este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o Maji...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o Maji em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o Maji...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o Maji em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o Maji em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o Maji",
  "wsl.onboarding.opencodeReadyIn": "O Maji está pronto em {{distro}}.",
  "wsl.onboarding.opencodeReady": "O Maji está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o Maji em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o Maji",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Maji não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o Maji possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O Maji não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o Maji novamente.",
  ...
  "toast.update.description": "Uma nova versão do Maji ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Maji",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (maji.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Maji ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Maji inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Maji dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Maji",
  ...
  "settings.general.row.appearance.description": "Personalize como o Maji aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Maji segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Maji é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Maji iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Maji.",
