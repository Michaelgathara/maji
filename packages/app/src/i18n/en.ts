export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Maji",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Maji.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "Maji Zen gives you access to a curated set of reliable optimized models for coding agents.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Maji.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Maji.",
  ...
  "dialog.plugins.empty": "Plugins configured in maji.json",
  ...
  "dialog.server.description": "Switch which Maji server this app connects to.",
  ...
  "wsl.onboarding.checkingOpencode": "Checking Maji...",
  "wsl.onboarding.checkingOpencodeIn": "Checking Maji in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating Maji...",
  "wsl.onboarding.updatingOpencodeIn": "Updating Maji in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update Maji in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update Maji",
  "wsl.onboarding.opencodeReadyIn": "Maji is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Maji is ready.",
  "wsl.onboarding.installOpencodeIn": "Install Maji in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install Maji",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Maji not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before Maji can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "Maji could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Maji.",
  ...
  "toast.update.description": "A new version of Maji ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Maji team",
  ...
  "error.chain.checkConfig": "Check your config (maji.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Maji does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Maji includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the Maji server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Maji",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Maji looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Maji follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Maji is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Maji launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Maji.",
