export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من Maji",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Maji.",
  ...
  "provider.connect.opencodeZen.line1":
    "يمنحك Maji Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Maji.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في Maji.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في maji.json",
  ...
  "dialog.server.description": "تبديل خادم Maji الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من Maji...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من Maji في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث Maji...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث Maji في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث Maji في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث Maji",
  "wsl.onboarding.opencodeReadyIn": "Maji جاهز في {{distro}}.",
  "wsl.onboarding.opencodeReady": "Maji جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت Maji في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت Maji",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Maji غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن Maji من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على Maji التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح Maji.",
  ...
  "toast.update.description": "نسخة جديدة من Maji ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق Maji",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (maji.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن Maji لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن Maji نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم Maji داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Maji",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Maji على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان Maji يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Maji.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل Maji",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من Maji.",
