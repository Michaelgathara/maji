export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Maji",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Maji.",
  ...
  "provider.connect.opencodeZen.line1":
    "Maji Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Maji.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Maji.",
  ...
  "dialog.plugins.empty": "Plugins configurados en maji.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de Maji se conecta esta app.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando Maji...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando Maji en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando Maji...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando Maji en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza Maji en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar Maji",
  "wsl.onboarding.opencodeReadyIn": "Maji está listo en {{distro}}.",
  "wsl.onboarding.opencodeReady": "Maji está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala Maji en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar Maji",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Maji no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que Maji pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Maji no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir Maji.",
  ...
  "toast.update.description": "Una nueva versión de Maji ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de Maji",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (maji.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, Maji no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "Maji incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Maji dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Maji",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve Maji en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Maji sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Maji.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Maji",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Maji.",
