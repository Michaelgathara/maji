export const dict = {
  ...
  "dialog.provider.custom.label": "Fournisseur personnalisé compatible OpenAI",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Maji",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Maji.",
  ...
  "provider.connect.opencodeZen.line1":
    "Maji Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.opencodeZen.visit.link": "Maji Zen",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Maji.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Maji.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans maji.json",
  ...
  "dialog.server.description": "Changez le serveur Maji auquel cette application se connecte.",
  ...
  "wsl.onboarding.step.opencode": "Maji",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'Maji...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'Maji dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'Maji...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'Maji dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour Maji dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour Maji",
  "wsl.onboarding.opencodeReadyIn": "Maji est prêt dans {{distro}}.",
  "wsl.onboarding.opencodeReady": "Maji est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez Maji dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer Maji",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Maji non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'Maji puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "Maji n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez Maji.",
  ...
  "toast.update.description":
    "Une nouvelle version d'Maji ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Maji",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (maji.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Maji ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "Maji inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Maji dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Maji",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Maji sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Maji suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Maji.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Maji",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Maji.",
