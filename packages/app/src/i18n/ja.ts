export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Majiが提供する無料モデル",
  "dialog.model.unpaid.addMore.title": "人気のプロバイダーからモデルを追加",
  "dialog.model.unpaid.viewMoreProviders": "さらに70以上のプロバイダーを表示",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、Majiで{{provider}}モデルを使用します。",
  ...
  "provider.connect.opencodeZen.line1":
    "Maji Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してMajiで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、Majiで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "maji.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するMajiサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpencode": "Majiを確認中...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のMajiを確認中...",
  "wsl.onboarding.updatingOpencode": "Majiを更新中...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のMajiを更新中...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のMajiを更新してください。",
  "wsl.onboarding.updateOpencode": "Majiを更新",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}内のMajiの準備ができました。",
  "wsl.onboarding.opencodeReady": "Majiの準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}にMajiをインストールしてください。",
  "wsl.onboarding.installOpencode": "Majiをインストール",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Majiがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "MajiでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、Majiをもう一度開いてください。",
  ...
  "toast.update.description": "Majiの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをMajiチームに報告してください: ",
  ...
  "error.chain.checkConfig": "config (maji.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: MajiはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "Majiには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でMajiサーバーを実行します。",
  ...
  "settings.general.row.language.description": "Majiの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのMajiの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "Majiがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "Majiのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "Maji の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "Maji は最新バージョンです。",
