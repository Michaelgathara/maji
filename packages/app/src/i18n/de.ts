...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Maji",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Maji zu nutzen.",
  ...
  "provider.connect.opencodeZen.line1":
    "Maji Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in Maji zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Maji zu nutzen.",
  ...
  "dialog.plugins.empty": "In maji.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den Maji-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.checkingOpencode": "Maji wird geprüft...",
  "wsl.onboarding.checkingOpencodeIn": "Maji in {{distro}} wird geprüft...",
  "wsl.onboarding.updatingOpencode": "Maji wird aktualisiert...",
  "wsl.onboarding.updatingOpencodeIn": "Maji in {{distro}} wird aktualisiert...",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie Maji in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Maji aktualisieren",
  "wsl.onboarding.opencodeReadyIn": "Maji ist in {{distro}} bereit.",
  "wsl.onboarding.opencodeReady": "Maji ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie Maji in {{distro}}.",
  "wsl.onboarding.installOpencode": "Maji installieren",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Maji nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor Maji einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "Maji konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann Maji erneut.",
  ...
  "toast.update.description": "Eine neue Version von Maji ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Maji-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (maji.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Maji unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "Maji enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "Maji-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Maji ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie Maji auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob Maji dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Maji anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Maji automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von Maji.",
