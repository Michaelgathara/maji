...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Maji",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Maji.",
  ...
  "provider.connect.opencodeZen.line1":
    "Maji Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Maji.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Maji.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i maji.json",
  ...
  "dialog.server.description": "Bytt hvilken Maji-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Maji ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Maji-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (maji.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Maji ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Maji inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Maji-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Maji",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Maji ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om Maji skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Maji er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Maji starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Maji.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker Maji...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker Maji i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer Maji...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer Maji i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater Maji i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater Maji",
  "wsl.onboarding.opencodeReadyIn": "Maji er klar i {{distro}}.",
  "wsl.onboarding.opencodeReady": "Maji er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer Maji i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Maji er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før Maji kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "Maji kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter Maji på nytt.",
