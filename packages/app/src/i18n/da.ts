export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Maji",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i Maji.",
  ...
  "provider.connect.opencodeZen.line1":
    "Maji Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i Maji.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i Maji.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i maji.json",
  ...
  "dialog.server.description": "Skift hvilken Maji-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker Maji...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker Maji i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer Maji...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer Maji i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater Maji i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater Maji",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Maji er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før Maji kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "Maji kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter Maji igen.",
  ...
  "toast.update.description": "En ny version af Maji ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Maji-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (maji.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Maji understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Maji inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Maji-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Maji",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan Maji ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om Maji følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan Maji er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Maji starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Maji.",
