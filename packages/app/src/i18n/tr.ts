...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Maji tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Maji'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.opencodeZen.line1":
    "Maji Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak Maji'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Maji'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler maji.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Maji sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "Maji kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde Maji kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "Maji güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde Maji güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki Maji'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "Maji'u güncelle",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} içinde Maji hazır.",
  "wsl.onboarding.opencodeReady": "Maji hazır.",
  "wsl.onboarding.installOpencodeIn": "Maji'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "Maji'u kur",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Maji kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Maji'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "Maji bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından Maji'u tekrar açın.",
  ...
  "toast.update.description": "Maji'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Maji ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (maji.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: Maji henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Maji ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Maji Masaüstü",
  ...
  "settings.desktop.wsl.description": "Maji sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Maji'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "Maji'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Maji'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Maji'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Maji başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Maji'un en son sürümünü kullanıyorsunuz.",
