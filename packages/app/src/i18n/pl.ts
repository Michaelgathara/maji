export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Maji",
  "dialog.model.unpaid.addMore.title": "Dodaj więcej modeli od popularnych dostawców",
  "dialog.model.unpaid.viewMoreProviders": "Zobacz ponad 70 dodatkowych dostawców",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Maji.",
  ...
  "provider.connect.opencodeZen.line1":
    "Maji Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Maji.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Maji.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w maji.json",
  ...
  "dialog.server.description": "Przełącz serwer Maji, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie Maji...",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie Maji w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie Maji...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie Maji w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj Maji w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj Maji",
  "wsl.onboarding.opencodeReadyIn": "Maji jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.opencodeReady": "Maji jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj Maji w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj Maji",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Maji nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim Maji będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "Maji nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz Maji.",
  ...
  "toast.update.description": "Nowa wersja Maji ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Maji",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (maji.json) nazwy dostawców/modeli",
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: Maji nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "Maji zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer Maji wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Maji",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd Maji na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Maji ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Maji.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Maji",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Maji.",
