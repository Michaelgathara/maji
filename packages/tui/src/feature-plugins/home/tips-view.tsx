...
const TIPS: Tip[] = [
  ...
  "Run {highlight}/share{/highlight} to create a public link to your conversation at Maji",
  ...
  "Create {highlight}maji.json{/highlight} for server settings and {highlight}tui.json{/highlight} for TUI settings",
  ...
  "Add {highlight}.md{/highlight} files to {highlight}.maji/commands/{/highlight} to define reusable custom prompts",
  "Use {highlight}$ARGUMENTS{/highlight}, {highlight}$1{/highlight}, {highlight}$2{/highlight} in custom commands for dynamic input",
  "Use backticks in commands to inject shell output (e.g., {highlight}`git status`{/highlight})",
  "Add {highlight}.md{/highlight} files to {highlight}.maji/agents/{/highlight} for specialized AI personas",
  ...
  "Use {highlight}maji run --attach{/highlight} to connect to a running server",
  "Run {highlight}maji upgrade{/highlight} to update to the latest version",
  "Run {highlight}maji auth list{/highlight} to see all configured providers",
  "Run {highlight}maji agent create{/highlight} for guided agent creation",
  "Use {highlight}/maji{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}maji github install{/highlight} to set up the GitHub workflow",
  "Comment {highlight}/maji fix this{/highlight} on issues to auto-create PRs",
  "Comment {highlight}/oc{/highlight} on PR code lines for targeted code reviews",
  'Use {highlight}"theme": "system"{/highlight} to match your terminal\'s colors',
  "Create JSON theme files in {highlight}.maji/themes/{/highlight} directory",
  ...
  "Run {highlight}docker run -it --rm ghcr.io/Michaelgathara/maji{/highlight} for containerized use",
  "Use {highlight}/connect{/highlight} with Maji Zen for curated, tested models",
