...
export const Definitions = {
  ...
  app_toggle_session_directory_filter: keybind("none", "Toggle task directory filtering"),
  ...
  scrollbar_toggle: keybind("none", "Toggle task scrollbar"),
  status_view: keybind("<leader>s", "View status"),
  debug_view: keybind("none", "View debug info"),

  session_export: keybind("<leader>x", "Export task to editor"),
  session_copy: keybind("none", "Copy task transcript"),
  session_move: keybind("none", "Move task"),
  session_new: keybind("<leader>n", "Create a new task"),
  session_list: keybind("<leader>l", "List all tasks"),
  session_timeline: keybind("<leader>g", "Show task timeline"),
  session_fork: keybind("none", "Duplicate task from message"),
  session_rename: keybind("ctrl+r", "Rename task"),
  session_delete: keybind("ctrl+d", "Delete task"),
  session_share: keybind("none", "Share current task"),
  session_unshare: keybind("none", "Unshare current task"),
  session_interrupt: keybind("escape", "Stop current task"),
  session_background: keybind("ctrl+b", "Background synchronous subagents"),
  session_compact: keybind("<leader>c", "Compact the task"),
  ...
  session_child_first: keybind("<leader>down", "Go to first child task"),
  session_child_cycle: keybind("right", "Go to next child task"),
  session_child_cycle_reverse: keybind("left", "Go to previous child task"),
  session_parent: keybind("up", "Go to parent task"),
  session_pin_toggle: keybind("ctrl+f", "Pin or unpin task in the task list"),
  session_quick_switch_1: keybind("<leader>1", "Switch to task in quick slot 1"),
  session_quick_switch_2: keybind("<leader>2", "Switch to task in quick slot 2"),
  session_quick_switch_3: keybind("<leader>3", "Switch to task in quick slot 3"),
  session_quick_switch_4: keybind("<leader>4", "Switch to task in quick slot 4"),
  session_quick_switch_5: keybind("<leader>5", "Switch to task in quick slot 5"),
  session_quick_switch_6: keybind("<leader>6", "Switch to task in quick slot 6"),
  session_quick_switch_7: keybind("<leader>7", "Switch to task in quick slot 7"),
  session_quick_switch_8: keybind("<leader>8", "Switch to task in quick slot 8"),
  session_quick_switch_9: keybind("<leader>9", "Switch to task in quick slot 9"),
  session_attention_jump: keybind("<leader>0", "Open the task that needs attention"),
  ...
  prompt_route_cycle: keybind("ctrl+o", "Choose a task for this prompt"),
...
export const CommandMap = {
  ...
  prompt_route_cycle: "prompt.route.cycle",
