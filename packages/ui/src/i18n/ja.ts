export const dict = {
  ...
  "ui.sessionReview.diffStyle.unified": "統合差分",
  "ui.sessionReview.diffStyle.split": "分割差分",
  ...
  "ui.sessionReviewV2.expandMode": "差分を展開または折りたたむ",
  "ui.sessionReviewV2.filterFiles": "ファイルを絞り込む",
  "ui.sessionReviewV2.toggleSidebar": "ファイルツリーを切り替える",
  "ui.sessionReviewV2.showAllLines": "すべての行を表示",
  "ui.sessionReviewV2.hideNonDiffLines": "差分以外の行を非表示",
  "ui.sessionReviewV2.unifiedDiff": "統合差分",
  "ui.sessionReviewV2.splitDiff": "分割差分",
  "ui.sessionReviewV2.previousFile": "前のファイル",
  "ui.sessionReviewV2.nextFile": "次のファイル",
  "ui.sessionReviewV2.diffView": "差分ビュー",
  ...
  "ui.sessionTurn.diffs.changed.one": "変更済みファイル: {{count}}件",
  "ui.sessionTurn.diffs.changed.other": "変更済みファイル: {{count}}件",
  "ui.sessionTurn.diffs.showAll": "すべて表示",
  "ui.sessionTurn.diffs.showLess": "一部のみ表示",
  "ui.sessionTurn.diffs.more": "+他{{count}}件",
  ...
  "dialog.usageExceeded.freeTier.description":
    "Maji Go にサブスクライブして、最高のオープンソースモデルに安定してアクセスできます。月額 $5 から。",
